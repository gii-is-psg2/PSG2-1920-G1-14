...
<petclinic:layout pageName="donations">
			...
			<table class="table table-striped">
				...
				<tr>
					...
					<td><fmt:formatNumber type="currency" maxFractionDigits="2"
							value="${cause.budgetTarget}" currencySymbol="&euro;" /></td>
				</tr>
				<tr>
					<th>Budget achieved</th>
					<td><fmt:formatNumber type="currency" maxFractionDigits="2"
							value="${cause.amount}" currencySymbol="&euro;" /></td>
				</tr>
				<tr>
					<th>Status</th>
					<td><c:choose>
	...
	<c:if test="${!cause.closed}">
		...
		<a href="${fn:escapeXml(newDonationUrl)}" class="btn btn-default">Make a donation</a>
	</c:if>
		...
		<tbody>
			<c:forEach items="${donations}" var="donation">
				<tr>
					...
					<td><fmt:formatNumber type="currency" maxFractionDigits="2"
							value="${donation.amount}" currencySymbol="&euro;" /></td>
					</td>
					<td><c:out
							value="${donation.client.firstName} ${donation.client.lastName}" />
					</td>
				</tr>
			</c:forEach>
		</tbody>
